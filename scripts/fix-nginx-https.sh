...
# Fix Nginx HTTPS configuration
# This script fixes the HTTP to HTTPS redirect issue
...
echo ""
echo "✅ Nginx HTTPS configuration fixed!"
echo "You can now access:"
echo "  - https://api.shisha.toof.jp/"
echo "  - https://api.shisha.toof.jp/health"